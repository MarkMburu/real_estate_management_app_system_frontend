        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Grid container>
                <Grid item xs={4}>
                    ...
                    <Controls.Input label="Location" name="location" value={values.location} onChange={handleInputChange} error={errors.projectname} />
                    <Controls.Input label="latitude" name="latitude" value={values.latitude} onChange={handleInputChange} error={errors.projectDetails} />
                    <Controls.Input label="longitude" name="longitude" value={values.longitude} onChange={handleInputChange} error={errors.numberofplots} />
